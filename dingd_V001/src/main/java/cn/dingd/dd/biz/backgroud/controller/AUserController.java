...
public class AUserController {
    ...
    public JsonResult selectFind(Auser auser, PageObject pageObject) {
        if (CF.isPage(pageObject))
            throw new NullPointerException("分页信息不正确!");
        Map<String, Object> map = aUserService.selectFind(auser, pageObject);
