...
public class TCarBasisInfoEntity implements Serializable {
	...
	public String toString() {
		return "TCarBasisInfoEntity [id=" + id + ", checkBillId=" + checkBillId + ", masterType=" + masterType
				...
				+ ", extinguisher=" + extinguisher + ", stall=" + stall + ", speed=" + speed + ", burning=" + burning
				+ ", damping=" + damping + ", clutch=" + clutch + ", muffler=" + muffler + ", suspension=" + suspension
				+ ", boosterRemark=" + boosterRemark + ", startRemark=" + startRemark + ", coolingRemark="
				+ coolingRemark + ", jackRemark=" + jackRemark + ", spareRemark=" + spareRemark + ", attritionRemark="
				+ attritionRemark + ", toolsRemark=" + toolsRemark + ", extinguisherRemark=" + extinguisherRemark
				+ ", placard=" + placard + ", placardRemark=" + placardRemark + ", stallRemark=" + stallRemark
				...
				+ ", mortgagePeriod=" + mortgagePeriod + ", imgList=" + imgList + ", dcount=" + dcount + ", rcount="
				+ rcount + ", priorityLevel=" + priorityLevel + ", askingPrice=" + askingPrice + ", createTime="
				+ createTime + ", removeTime=" + removeTime + ", title=" + title + ", carState=" + carState
				+ ", freezingTime=" + freezingTime + ", isbid=" + isbid + ", pcount=" + pcount + ", carMoney="
				+ carMoney + "]";
	}
