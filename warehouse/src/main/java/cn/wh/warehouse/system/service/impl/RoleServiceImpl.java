...
import cn.wh.warehouse.system.dao.RoleMenuDao;
...
public class RoleServiceImpl implements RoleService {
	...
	public void save(Role role,String menuIdList) {
		if(role==null){
			throw new NullPointerException("添加角色，角色对象不能为�?!");
		}
		//保存角色信息
	...
	public void updateRole(Role role,String menuIdList) {
		...
		int i = roleDao.updateObject(role);   //更新角色名称和备�?
		if(i!=1){  
	...
	/**
	 * 删除角色，删除前先判断是否有用户占用此角色，如果有，那么此角色不能删�?
	 * 如果可以删除，删除角色后，角色和菜单的关系也要删�?
	 */
