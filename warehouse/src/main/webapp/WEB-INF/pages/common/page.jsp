...
<ul class="pagination" style="cursor: pointer;">
		...
		<li
			...
			<strong id="currentPage">0/0</strong>页
		</li>
		<!-- 总记录数 -->
		<li
			style="padding: 6px 12px 6px 0px; border: 1px solid transparent; float: left">
			<strong id="totalCount">0</strong>条记录
		</li>
		<!-- 生成首页，上一页，下一页，尾页 -->
		<li><a class="firstPage">首页</a></li>
		<li><a title="上一页" class="upperPage" id="upperPage">&laquo;</a></li>
		<li><a title="下一页" class="nextPage" id="nextPage">&raquo;</a></li>
