...
<script src="${basePath}/echarts/css/echarts.simple.min.js"></script>
<script src="${basePath}/echarts/css/echarts-all-3.js"></script>
<script src="${basePath}/echarts/css/dataTool.min.js"></script>
<script src="${basePath}/echarts/css/china.js"></script>
<script src="${basePath}/echarts/css/world.js"></script>
<script src="${basePath}/echarts/css/bmap.min.js"></script>
   ...
   <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary ok" id='particularId'>保存</button>
      </div>
    </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
  </div><!-- modal -->
